...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function calculateRepairCost() {
    ...
    if (totalCost == 0 || totalCost == "" || totalCost == null) {
      repairCostValueP.innerHTML = `  Ориентировочная стоимость ремонта составила <span id="repair-cost-value"> 1 500 000 рублей</span>`

    } else {
      repairCostValue.textContent = totalCost.toLocaleString('ru-RU') + " рублей";
